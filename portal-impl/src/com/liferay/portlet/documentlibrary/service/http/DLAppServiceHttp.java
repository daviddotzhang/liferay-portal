...
public class DLAppServiceHttp {
	...
	public static int getFoldersAndFileEntriesAndFileShortcutsCount(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(methodKey,
					repositoryId, folderId, mimeTypes, includeMountFolders,
					queryDefinition);
	...
	public static void unsubscribeFileEntryType(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class,
					...
					_unsubscribeFileEntryTypeParameterTypes89);
	...
	public static void unsubscribeFolder(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class,
					"unsubscribeFolder", _unsubscribeFolderParameterTypes90);
	...
	private static final Class<?>[] _unsubscribeFileEntryTypeParameterTypes89 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[] _unsubscribeFolderParameterTypes90 = new Class[] {
			long.class, long.class
		};
