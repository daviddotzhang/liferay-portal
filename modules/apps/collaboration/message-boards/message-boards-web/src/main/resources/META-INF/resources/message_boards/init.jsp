...
page import="com.liferay.message.boards.util.comparator.MBCategoryThreadModifiedDateComparator" %><%@
page import="com.liferay.message.boards.util.comparator.MBCategoryThreadTitleComparator" %><%@
